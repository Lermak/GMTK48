...
cd Engine
copy /b love.exe+Game.zip FeedTheFurnace.exe
move FeedTheFurnace.exe "../Release"
...
cd Release
"%~dp0IconMaker/ResourceHacker.exe" -addoverwrite "FeedTheFurnace.exe", "FeedTheFurnace.exe", "%~dp0Game/Data/Images/Icon.ico", ICONGROUP, 1, 1
